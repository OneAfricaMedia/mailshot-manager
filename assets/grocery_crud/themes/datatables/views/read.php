	...
	<?php echo form_open( $read_url, 'method="post" id="crudForm"  enctype="multipart/form-data"'); ?>
		...
		<div class='buttons-box'>
			...
			<div class='form-button-box'>
				<input type='button' value='Show Todays Invoices' class='ui-input-button back-to-list' id="cancel-button" /> | <a href="<?php base_url(); ?>/crud/sale/edit/<?php echo $uri_segments[0]  ?>" >Edit</a>
			</div>
			<div class='clear'></div>
		</div>
	</form>
